...
public class TreeSetMethod_1 {
	public static void main(String[] args) {
		...
		TreeSet<Integer> treeSet = new TreeSet<>(); // → Set으로 하면 TreeSet만의 기능을 사용못해서 이런형태로 만듦
